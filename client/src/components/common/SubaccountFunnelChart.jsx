...
const SubaccountFunnelChart = ({ data }) => {
  return (
...
SubaccountFunnelChart.propTypes = {
  data: PropTypes.any,
};
...
function customToolTip({ payload, active }) {
  ...
  return (
    <div className="ml-[500px] dark:text-white text-black w-fit dark:bg-muted/60 backdrop-blur-md  bg-background/60 !rounded-lg p-2 shadow-2xl">
      <div className="flex items-center flex-1 space-x-2.5">
        <div
          className={`size-5 rounded-full bg-${categoryPayload?.color} rounded`}
        />
