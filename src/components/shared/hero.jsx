...
const Hero = () => {
  return (
    <>
      <section className="pt-[154px] w-full relative max-w-full h-full mb-[232px]">
        <div className="flex flex-col items-center justify-center text-center">
          ...
          >
            <AnimatedShinyText className="inline-flex items-center justify-center px-4 py-1 transition ease-out hover:text-neutral-600 hover:duration-300 hover:dark:text-neutral-400">
              <span className="text-sm font-normal">
                ✨ Lenas now realease version v1.
              </span>
              <ArrowRightIcon className="ml-1 size-3 transition-transform duration-300 ease-in-out group-hover:translate-x-0.5" />
            </AnimatedShinyText>
          </div>
          <IconsPlus className="absolute bottom-0 top-[7.3rem] left-44" />
          <IconsPlus className="absolute right-[10.3rem] bottom-[10.7rem]" />
          ...
          <div className="relative mt-56 text-transparent bg-gradient-to-r from-blue-400 to-white bg-clip-text">
            <h2 className="font-bold text-9xl">Lenas</h2>
          </div>
